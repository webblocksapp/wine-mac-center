...
export const WINE_APPS_DONWLOADABLES_URL = `${WINE_APPS_SRC_URL}/downloadables`;
export const WINE_APPS_SETUP_EXECUTABLES_URL = `${WINE_APPS_DONWLOADABLES_URL}/setup-executables`;
